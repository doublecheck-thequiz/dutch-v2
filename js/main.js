...
//--CLICK FUNCTION
  ...
  $('#RIGHT01').click(function() {
    window.location.replace('../right-wrong/right1.html?q1=' + giusto, '_self');
  });
  $('#WRONG01').click(function() {
    window.location.replace('../right-wrong/wrong1.html?q1=' + sbagliato, '_self');
  });
  ...
  $('#RIGHT02').click(function() {
    ...
    window.location.replace('../right-wrong/right2.html?q2=' + giusto2, '_self');
  });
  $('#WRONG02').click(function() {
    var risul1 = parseInt(check1, 10);
    let sbagliato2 = risul1 + 0;
    window.location.replace('../right-wrong/wrong2.html?q2=' + sbagliato2, '_self');
  });
  ...
  $('#RIGHT03').click(function() {
    ...
    window.location.replace('../right-wrong/right3.html?q3=' + giusto3, '_self');
  });
  $('#WRONG03').click(function() {
    var risul2 = parseInt(check2, 10);
    let sbagliato3 = risul2 + 0;
    window.location.replace('../right-wrong/wrong3.html?q3=' + sbagliato3, '_self');
  });
  ...
  $('#RIGHT04').click(function() {
    ...
    window.location.replace('../right-wrong/right4.html?q4=' + giusto4, '_self');
    $('#RETINO04').fadeIn();
  });
  $('#WRONG04').click(function() {
    var risul3 = parseInt(check3, 10);
    let sbagliato4 = risul3 + 0;
    window.location.replace('../right-wrong/wrong4.html?q4=' + sbagliato4, '_self');
  });
  var tempo = gsap.timeline(); //--Rettangolo che pulsa nel fact
  ...
  $('#RIGHT05').click(function() {
    ...
    window.location.replace('../right-wrong/right5.html?q5=' + giusto5, '_self');
  });
  $('#WRONG05').click(function() {
    var risul4 = parseInt(check4, 10);
    let sbagliato5 = risul4 + 0;
    window.location.replace('../right-wrong/wrong5.html?q5=' + sbagliato5, '_self');
  });
  ...
  $('#RIGHT06primo').click(function() {
    ...
    if (flag01 == 1 && flag02 == 1 && flag03 == 1 && flag04 == 1) {
      ...
      window.location.replace('../right-wrong/right6.html?q6=' + giusto6, '_self');
    }
  });
  ...
  $('#WRONG06').click(function() {
    ...
    window.location.replace('../right-wrong/wrong6.html?q6=' + sbagliato6, '_self');
  });
  var tempo = gsap.timeline(); //--Rettangolo che pulsa nel fact
  ...
  $('#RIGHT07').click(function() {
    ...
    window.location.replace('../right-wrong/right7.html?q7=' + giusto7, '_self');
  });
  $('#WRONG07').click(function() {
    var risul6 = parseInt(check6, 10);
    let sbagliato7 = risul6 + 0;
    window.location.replace('../right-wrong/wrong7.html?q7=' + sbagliato7, '_self');
  });
  ...
  $('#RIGHT08').click(function() {
    ...
    window.location.replace('../right-wrong/right8.html?q8=' + giusto8, '_self');
  });
  $('#WRONG08').click(function() {
    var risul7 = parseInt(check7, 10);
    let sbagliato8 = risul7 + 0;
    window.location.replace('../right-wrong/wrong8.html?q8=' + sbagliato8, '_self');
  });
  ...
  $('#SKIPW').click(function() {
    ...
    window.location.replace('./q/q10.html?q9=' + giusto9, '_self');
  });
  ...
  $('#RIGHT09').click(function() {
    var risul8 = parseInt(check8, 10);
    let giusto9 = risul8 + 1;
    window.location.replace('../right-wrong/right9.html?q9=' + giusto9, '_self');
  });
  $('#WRONG09').click(function() {
    var risul8 = parseInt(check8, 10);
    let sbagliato9 = risul8 + 0;
    window.location.replace('../right-wrong/wrong9.html?q9=' + sbagliato9, '_self');
  });
  ...
  $('#RIGHT10').click(function() {
    ...
    window.location.replace('../right-wrong/right10.html?q10=' + giusto10, '_self');
  });
  $('#WRONG10').click(function() {
    var risul9 = parseInt(check9, 10);
    let sbagliato10 = risul9 + 0;
    window.location.replace('../right-wrong/wrong10.html?q10=' + sbagliato10, '_self');
  });
  ...
  $('#RIGHT11').click(function() {
    ...
    window.location.replace('../right-wrong/right11.html?q11=' + giusto11, '_self');
  });
  $('#WRONG11').click(function() {
    var risul10 = parseInt(check10, 10);
    let sbagliato11 = risul10 + 0;
    window.location.replace('../right-wrong/wrong11.html?q11=' + sbagliato11, '_self');
  });
  ...
  $('#merkelOK1').click(function() {
    ...
    if (merkel01 == 1 && merkel02 == 1) {
      ...
      window.location.replace('../right-wrong/right12.html?q12=' + giusto12, '_self');
    }
  });
  ...
  $('#merkelNO').click(function() {
    ...
    window.location.replace('../right-wrong/wrong12.html?q12=' + sbagliato12, '_self');
  });
  var tempo = gsap.timeline(); //--Rettangolo che pulsa nel fact
